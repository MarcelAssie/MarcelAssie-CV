...
\begin{itemize}[leftmargin=0.5cm, nosep]
    ...
    \item Développement de modules d'extraction et de traitement pour divers SGBD (Oracle, SQL Server) et formats géographiques (GeoPackage, GeoParquet, fichiers CAO) via GDAL et SQL.
...
\textbf{Bases de données :} PostgreSQL/PostGIS, Oracle Spatial, SQL Server, Neo4j \\
\textbf{Technologies Web \& Ops :} Docker, GitHub, Django, Flask, Vue.js, React Native \\
\textbf{Bibliothèques SIG :} GDAL, Proj, GeoPandas, ArcPy, PyQGIS, Shapely, Leaflet.js \\
\textbf{Outils \& Formats :} QGIS, ArcGIS Pro, FME, GeoServer, AutoCAD $\vert$ GeoParquet, GeoPackage, CAO \\
\textbf{Aptitudes professionnelles :} Forte capacité d’adaptation, Rigueur, Esprit critique et d'analyse, Prise d’initiative
% ================= PROJETS =================
\section*{Projets}

\begin{itemize}[leftmargin=0.5cm, nosep]
    \item \textbf{Extraction de données contextuelles (ODD)} : \href{https://github.com/MarcelAssie/PIR18}{\faGithub~GitHub}
    \begin{itemize}[leftmargin=0.5cm, nosep]
    ...
    \end{itemize}
    \vspace{0.2cm}
    \item \textbf{Application mobile de navigation (Gendarmerie nationale)} : \href{https://github.com/WYBG/PDI-APP-Nav-WAZE}{\faGithub~GitHub}
    \begin{itemize}[leftmargin=0.5cm, nosep]
    ...
    \end{itemize}
    \vspace{0.2cm}
    \item \textbf{Étude Spatio-Statistique (Île-de-France)} : \href{https://github.com/MarcelAssie/SpatialAnalysisProject}{\faGithub~GitHub}
    \begin{itemize}[leftmargin=0.5cm, nosep]
    ...
    \end{itemize}
    \vspace{0.2cm}
    \item \textbf{Plateforme SaaS KlassIvoire} : \href{https://klassivoire.kaedys.com/}{\faGlobe~Site web}
    \begin{itemize}[leftmargin=0.5cm, nosep]
    ...
    \end{itemize}
    \vspace{0.2cm}
    \item \textbf{Plateforme d'analyse d'établissements scolaires} : \href{https://github.com/MarcelAssie/SIGWEB}{\faGithub~GitHub}
    \begin{itemize}[leftmargin=0.5cm, nosep]
